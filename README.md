...
- 🔍 **Мультиплатформенность** — поддержка Kwork.ru, Weblancer, FL.ru (RSS), Freelancer.com
...
- 💸 **Бесплатные отклики** — FL.ru и Freelancer.com не требуют платных «коннектов» для отклика (в отличие от Kwork)
- 🌍 **ИИ-перевод** — англоязычные заказы с Freelancer анализируются и получают отклик на русском автоматически
...
│   ├── parser-weblancer.ts        # Парсер Weblancer
│   ├── parser-flru.ts             # Парсер FL.ru (RSS)
│   ├── parser-freelancer.ts       # Парсер Freelancer.com (HTML)
...
- **FL.ru** — парсинг RSS-ленты (`/rss/all.xml`): русскоязычные заказы, бесплатные отклики, бюджет в ₽
- **Freelancer.com** — HTML парсинг карточек (`JobSearchCard`): англоязычные заказы, бесплатные bids, бюджет конвертируется $→₽ (env `USD_RATE`, по умолчанию 90), отклик генерится на русском через ИИ
