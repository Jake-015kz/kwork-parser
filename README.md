...
- 🔍 **Мультиплатформенность** — поддержка Kwork.ru, Weblancer, Freelancer.com
...
- 💸 **Бесплатные отклики** — Freelancer.com не требует платных «коннектов» для отклика (в отличие от Kwork)
...
- **Weblancer** — HTML парсинг по целевым подкатегориям (обновлён маппинг slug'ов)
